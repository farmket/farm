...
from .views import login_page,password_reset    , RegisterView, guest_register_view,logout_user,activate,RegisterViewService
...
#    path(        'change-password/',   auth_views.PasswordChangeView.as_view(template_name='accounts/change-password.html'), ),
    ...
    url(r'^registerservice/$', RegisterViewService, name='registerservice'),
